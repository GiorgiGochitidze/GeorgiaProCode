  ...
  return (
    <div className="entering-container">
      ...
      <p>
        ...
        div, <span className="code">&lt;div&gt;</span> ელემენტი მის შიგნით მყოფ
        ელემენტებს აქცევს ერთ კონტეინერში, შედარებისთვის div არის იგივე ყუთი
        რომელშიც შეგიძლიათ ჩადოთ სათამაშო თუ ბურთი ნებისმიერი სახის ნივთი, ასევე
        div-ზე გამოყენებული სტილები/სტილიზაცია მიენიჭება მის შიგნით მყოფ
        ელემენტებსაც მათი განსაზღვრა შეგვიძლია CSS-ში გარდა ამისა div არის block
        ელემენტი block და inline ელემენტებს გავივლით შემდეგ გაკვეთილზე:
      </p>

      <h1>span ელემენტი</h1>

      <p>
        <span className="code">&lt;span&gt;</span> ელემენტი არის HTML ელემენტი
        რომელიც გამოიყენება ტექსტის რედაქტირებისთვის მასზე სტილების მისაცემად ის
        არის inline ელემენტი რომელიც იჭერს მხოლოდ იმდენ ადგილს რამდენსაც იჭერს
        ტექსტი ან სხვა ელემენტები
      </p>

...
const Course2 = () => {
    return ( 
        <div className="entering-container">
            ...
            რიცხვის მატებასთან ერთად იკლებს ზომა მაგალითი შეგიძლიათ იხილოთ ქვემოთ: ("Hint": როცა იყენებთ
            ედიტორს აუცილებლად დააჭირეთ ctrl + s-ს რათა შეინახოთ ცვლილებები და ნახოთ ცვლილებები დემოზე)</p>
            ...
            <Link to='/Html/Course3'><button>გაკვეთილი N3</button></Link>
        </div>
     );
}
